...
from voxel.devices.axes.continous import StepMode, TriggerMode, TTLStepper, TTLStepperConfig, VoxelAxis
from voxel.devices.controller.tigerhub.model.axis_state import AxisState
from voxel.devices.controller.tigerhub.model.models import ASIAxisInfo
from voxel.devices.controller.tigerhub.ops.params import TigerParam, TigerParams
from voxel.devices.controller.tigerhub.ops.step_shoot import RingBufferMode, StepShootConfig, TTLIn0Mode, TTLOut0Mode


class TigerTTLStepper(TTLStepper):
    def __init__(self, axis: "TigerAxis"):
        self._axis = axis
...
if __name__ == "__main__":
    ...
    from voxel.devices.controller.tigerhub.hub import TigerHub
    ...
    def log_axis_info(ax: VoxelAxis) -> None:
