...
from voxel.new.drivers.tigerhub.model.axis_state import AxisState
from voxel.new.drivers.tigerhub.model.models import ASIAxisInfo
from voxel.new.drivers.tigerhub.ops.params import TigerParam, TigerParams
from voxel.new.drivers.tigerhub.ops.step_shoot import RingBufferMode, StepShootConfig, TTLIn0Mode, TTLOut0Mode
from voxel.new.interfaces.axes.continuous import ContinuousAxis, StepMode, TriggerMode, TTLStepper, TTLStepperConfig
...
class TigerAxis(ContinuousAxis):
    POS_MULT = 10000
