...
from voxel.new.device import describe
from voxel.new.interfaces.axes.base import BaseAxis
from voxel.new.interfaces.spim import DeviceType


# TODO: Consider merging with continuous if needed
class RotationAxis(BaseAxis):
