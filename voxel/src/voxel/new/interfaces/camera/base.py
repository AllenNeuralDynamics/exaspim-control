...
from voxel.new.interfaces.camera.roi import ROI, ROIAlignmentPolicy, ROIConstraints, coerce_roi
...
class SpimCamera(SpimDevice):
    ...
    @property
    @describe(label="Frame Size", units="px", desc="The image size in pixels after ROI and binning.")
