...
from voxel.devices.controller.tigerhub.model import ASIMode, AxisState, BoxInfo, Reply
from voxel.devices.controller.tigerhub.model.box_info import infer_comm_addr_from_who
from voxel.devices.controller.tigerhub.model.card_info import CardInfo
from voxel.devices.controller.tigerhub.model.models import ASIAxisInfo
from voxel.devices.controller.tigerhub.ops.joystick import (
    JoystickEnableOp,
...
from voxel.devices.controller.tigerhub.ops.motion import (
    HaltOp,
    HereOp,
    HomeOp,
    IsAxisBusyOp,
...
from voxel.devices.controller.tigerhub.ops.params import GetParamOp, SetParamOp, TigerParam, TigerParams
from voxel.devices.controller.tigerhub.ops.scan import (
    ArrayOp,
    ArrayScanConfig,
    AutoHomeConfig,
    AutoHomeOp,
...
from voxel.devices.controller.tigerhub.ops.status import (
    GetAxisStateOp,
    GetBuildOp,
    GetCardMods,
    GetPiezoInfoOp,
...
from voxel.devices.controller.tigerhub.ops.step_shoot import (
    GetTTLModesOp,
    LoadBufferedMoveOp,
    ProbeTTLOutOp,
    ProbeTTLOutOp2,
...
from voxel.devices.controller.tigerhub.protocol.errors import ASIDecodeError
from voxel.devices.controller.tigerhub.protocol.parser import asi_parse
from voxel.devices.utils.serial import SerialTransport
...
class TigerBox:
    ...
    def __init__(self, port: str):
        self.log = logging.getLogger(f"TigerBox[{port}]")
    ...
    def info(self, *, refresh: bool = False) -> BoxInfo:
        ...
        if issues := self._info.issues:
            for issue in issues:
                self.log.debug(f"BoxInfo warning: {issue}")
        return self._info
