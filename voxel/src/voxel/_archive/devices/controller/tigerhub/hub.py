...
from voxel.devices.utils.poller import Poller

from .box import TigerBox
from .model.models import ASIAxisInfo
from .ops.params import TigerParams
...
class TigerHub(VoxelDevice):
    ...
    def __init__(self, com_port: str, uid: str = "TigerBox") -> None:
        super().__init__(uid=uid)
        self._box = TigerBox(com_port)
