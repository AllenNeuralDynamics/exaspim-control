...
ACQUISITION_YAML = RESOURCES_DIR / "simulated_acquisition.yaml"
    ...
    def grab_frames(self, camera_name, frames=float("inf")):
        ...
        while i < frames:  # while loop since frames can == inf
            ...
            for binning in range(2, 6):  # TODO: variable or get from somewhere?
                downsampled_frame = cle.scale(
                    input_frame, factor_x=1 / binning, factor_y=1 / binning, device=cle.select_device(), resize=True
                )
