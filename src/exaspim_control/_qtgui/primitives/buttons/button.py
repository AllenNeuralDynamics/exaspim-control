...
class Button(QPushButton):
    ...
    Usage:
        ...
        btn = Button("✕", variant="overlay")  # For floating buttons
        btn = Button("Halt", variant="danger")  # For destructive actions
    """
    ...
    def __init__(
        ...
        Args:
            text: Button text
            variant: Style variant - "primary", "secondary", "overlay", or "danger"
            icon: Optional icon
...
class IconButton(QPushButton):
    ...
    Usage:
        ...
        btn = IconButton(text="✕", size=24)  # Text-only small button
    """
    ...
    def __init__(
        ...
        Args:
            icon: Button icon
            text: Button text (for text-only icon buttons like "✕")
