...
class VSpinBox(QSpinBox):
    ...
    Usage:
        VSpinBox()
        VSpinBox(value=10, min=0, max=100)
        VSpinBox(value=5, min=1, max=10, step=1)
    """
...
class VDoubleSpinBox(QDoubleSpinBox):
    ...
    Usage:
        VDoubleSpinBox()
        VDoubleSpinBox(value=1.5, min=0.0, max=10.0)
        VDoubleSpinBox(value=1.33, min=1.0, max=2.0, decimals=3, step=0.01)
    """
