...
def convolve_spatial2(im, hs, mode="constant", plan=None, return_plan=False):
    ...
    prog = OCLProgram(abspath("kernels/conv_spatial.cl"), build_options=["-D", "ADDRESSMODE=%s" % mode_str[mode]])
...
def convolve_spatial3(im, hs, mode="constant", plan=None, return_plan=False, pad_factor=2):
    """
