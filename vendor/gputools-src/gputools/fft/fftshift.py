...
DTYPE_KERNEL_NAMES = {np.float32: "fftshift_1_f", np.complex64: "fftshift_1_c"}
...
def _fftshift_single(d_g, res_g, ax=0):
    ...
    dtype_kernel_name = {np.float32: "fftshift_1_f", np.complex64: "fftshift_1_c"}
    ...
    prog.run_kernel(dtype_kernel_name[dtype], (N2, N // 2, N1), None, d_g.data, res_g.data, np.int32(N), np.int32(N2))
...
if __name__ == "__main__":
    ...
    d[Nz // 2 - 30 : Nz // 2 + 30, Ny // 2 - 20 : Ny // 2 + 20, Nx // 2 - 20 : Nx // 2 + 20] = 2.0
